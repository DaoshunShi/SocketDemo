...
/*
 * Transfering large sized file through SocketChannel
...
public class FileReceiver {
	...
	private void readFileFromSocketChannel(SocketChannel socketChannel) throws IOException {
		...
		Path path = Paths.get("D:\\Project\\SocketTest\\Get\\File\\¾ü»ð··.rmvb");
	...
	private SocketChannel createServerSocketChannel() throws IOException {
		...
		System.out.println("connection establisned .. " + client.getRemoteAddress());
