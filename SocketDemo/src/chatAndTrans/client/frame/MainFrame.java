package chatAndTrans.client.frame;
...
import chatAndTrans.client.listener.ClientListener;
...
public class MainFrame extends JFrame {
	...
	public JComboBox combobox;	//选择发送消息的接收者
	...
	//建立菜单项
	public JMenuItem loginItem = new JMenuItem("用户登陆");
	...
	//建立工具栏中的按钮组件
	public JButton loginButton;	//用户登陆
	...
	//框架的大小
	Dimension faceSize = new Dimension(450, 600);
	...
	public void init() {
		...
		messageScrollPane.setPreferredSize(new Dimension(450, 400));
...
//		girdBagCon.ipadx = 0;
//		girdBagCon.ipady = 0;
//		JLabel none = new JLabel("00000000000");
