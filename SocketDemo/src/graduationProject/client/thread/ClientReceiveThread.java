package graduationProject.client.thread;
...
public class ClientReceiveThread extends Thread {
	...
	public ClientReceiveThread(Socket socket, ObjectOutputStream output, ObjectInputStream input, JComboBox combobox, JTextArea textarea, JTextField showStatus ) {
		this.socket = socket;
		this.output = output;
		this.input = input;
